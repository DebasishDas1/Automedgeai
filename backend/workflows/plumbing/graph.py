...
from workflows.plumbing.nodes import score_urgency, dispatch_tech, book_appointment

def build_plumbing_graph() -> StateGraph:
...
plumbing_graph = build_plumbing_graph()
