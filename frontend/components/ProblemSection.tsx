    ...
    return (
        <section id="problem" className="py-24 px-6 max-w-7xl mx-auto scroll-mt-24">
            <div className="text-center mb-20">
                ...
                >
                    Leads go cold when you don't respond <br className="hidden md:block" /> within 5 minutes.
                </motion.h2>
                <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full -z-10 opacity-[0.05] pointer-events-none overflow-hidden">
                    <Clock className="absolute -top-10 -left-10 w-64 h-64 rotate-12" />
                    <MessageSquareOff className="absolute bottom-0 -right-20 w-80 h-80 -rotate-12" />
                </div>
