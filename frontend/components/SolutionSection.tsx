...
import { Sparkles, Target, Zap, Repeat, CalendarCheck, BarChart3 } from "lucide-react";
...
const SOLUTIONS = [
    ...
    },
    {
        ...
        title: "AI Booking",
        description: "Seamlessly integrate with your calendar to book appointments.",
    },
    {
        ...
        <section id="solution" className="py-24 px-6 bg-muted/30 scroll-mt-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    >
                        Automedge AI: Your 24/7 <br className="hidden md:block" /> AI Sales System
                    </motion.h2>
                    <motion.p
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 relative">
                    ...
                    {SOLUTIONS.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-outfit font-extrabold mb-4 tracking-tight">{item.title}</h3>
