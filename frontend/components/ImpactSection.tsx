...
import { Timer, ArrowUpCircle, XCircle, Users2, Clock3, TrendingUp } from "lucide-react";
...
export function ImpactSection() {
    return (
        <section id="impact" className="py-24 px-6 border-y border-border/10 scroll-mt-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-5xl md:text-7xl font-outfit font-[800] tracking-tighter"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-8">
                    {IMPACTS.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="text-6xl md:text-8xl font-outfit font-[900] mb-4 tracking-tighter">
                                {item.stat}
                            </div>
